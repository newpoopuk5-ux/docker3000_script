...
from muse_worker.paths import LLM_DIR, resolve_packaged_path

LLM_MODELS_JSON = resolve_packaged_path(os.environ.get("LLM_MODELS_JSON"), LLM_DIR / "llm_models.json", LLM_DIR)
