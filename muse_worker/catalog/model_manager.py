...
from muse_worker.paths import CATALOG_SOURCES_DIR, resolve_packaged_path

MODELS_JSON = resolve_packaged_path(os.environ.get("MODELS_JSON"), CATALOG_SOURCES_DIR / "models.json", CATALOG_SOURCES_DIR)
